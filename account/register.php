...
<ul class="member-btn ">
<li><a class="btn btn-secondary-primary" href="../account/login.php">Masuk</a></li>
<li><a class="btn btn-join" href="../account/register.php">Daftar</a></li>
</ul>
</div>
<ul class="menu-body">
...
<form id="RegisterForm" action="/api/account/register" method="POST">
<input type="hidden" id="Token" name="token" value="94d52d76335db10d6c3e1ecf716672b9eb6a7a5e0f9224349d97e221f208cbbf">
<div class="textfield-wrap" id="UsernameCheck">
<label for="username">Nama Pengguna <span>*</span></label>
<div class="group-wrap">
<div class="input-field">
<input type="text" name="username" id="Username" placeholder='Antara 5 dan 16 karakter' minlength="5" maxlength="16" required="required" data-validate="false" autocomplete="off">
...
<div class="group-wrap">
<div class="input-field">
<input type="password" name="password" id="Password" class="pwdinput" placeholder='Antara 6 dan 16 karakter' minlength="6" maxlength="16" required="required" autocomplete="off">
<i class="fas fa-times-circle"></i>
</div>
<button type="button" class="login-show-pass btn btn-grey btn-pwd-visibility" id="PasswordVisibility">Perlihatkan</button>
</div>
<span class="tooltip" data-area="message"></span>
</div>
...
<div class="input-field">
<input type="password" name="cpassword" id="CPassword" class="pwdinput" placeholder='Antara 6 dan 16 karakter' minlength="6" maxlength="16" required="required" autocomplete="off">
<i class="fas fa-times-circle"></i>
</div>
<span class="tooltip" data-area="message"></span>
</div>
...
<div class="input-field">
<input type="text" name="firstName" id="FirstName" required="required" autocomplete="off">
<i class="fas fa-times-circle"></i>
</div>
<span class="tooltip" data-area="message"></span>
</div>
...
<div class="input-field">
<input type="tel" name="mobileNumber" id="MobileNumber" minlength="7" maxlength="12" placeholder="81261xxx" required="required" autocomplete="off">
<i class="fas fa-times-circle"></i>
</div>
</div>
<span class="tooltip" data-area="message"></span>
...
<div class="input-field">
<input type="text" name="referral" id="Referral" maxlength="16" value="" data-validate="false" autocomplete="off" placeholder='contoh: poker123 atau dikosongkan apabila tidak ada'>
<i class="fas fa-times-circle"></i>
</div>
<span class="tooltip" data-area="message"></span>
</div>
...
<div class="group-wrap">
<div class="input-field">
<input type="text" name="captcha" id="Captcha" maxlength="4" autocomplete="off" required="required" data-validate="false">
<i class="fas fa-times-circle"></i>
</div>
<img src="../images/pick.jpg" id="imgCaptcha" class="img-captcha img-thumbnail" width="100" style="height:40px !important;margin-left:10px;">
...
<button class="btn-primary btn-space" type="submit" id="RegisterButton" onclick="location.href='../members.php'">Daftar</button>
</div>
</form>
</div>
<script>var button = {"show":"Perlihatkan","hide":"Sembunyikan"};</script>
<script src="https://cdn.robotaset.com/assets/js/common/Alert.js"></script>
<script src="https://cdn.robotaset.com/assets/js/pages/211116_Account.js"></script>
<script src="https://cdn.robotaset.com/assets/js/pages/AccountValidation.js"></script>
<script src="https://cdn.robotaset.com/assets/js/pages/211116_register.js"></script>
</main>
</div>
